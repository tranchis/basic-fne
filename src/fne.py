...
def full_network_embedding(model, image_paths, input_tensor, target_tensors, stats = np.empty((0,0))):
    ...
    #TODO: compute this number based on layers and remove constant
    len_features = 5484
    ...
    #Store output
    np.savez(open('../output/fne.pkl','wb'),features)
    np.savez(open('../output/stats.pkl','wb'),stats)
...
if __name__ == '__main__':
    ...
    target_tensors = ['import/mixed3a:0','import/mixed3b:0','import/mixed4a:0','import/mixed4b:0','import/mixed4c:0','import/mixed4d:0','import/mixed4e:0','import/mixed5a:0','import/mixed5b:0']
